...
from yolo_duplicate.layers.common import *
from yolo_duplicate.util.torch_utils import initialize_weights
from yolo_duplicate.models.efficientrep import *
from yolo_duplicate.models.reppan import *
# from yolo_duplicate.utils.events import LOGGER


class Model(nn.Module):
    export = False
    '''yolo_duplicate model with backbone, neck and head.
...
def build_network(config, channels, num_classes, num_layers, fuse_ab=False, distill_ns=False):
    ...
    if distill_ns:
        from yolo_duplicate.models.heads.effidehead_distill_ns import Detect, build_effidehead_layer
        if num_layers != 3:
        ...
        from yolo_duplicate.models.heads.effidehead_fuseab import Detect, build_effidehead_layer
        ...
        from yolo_duplicate.models.effidehead import Detect, build_effidehead_layer
